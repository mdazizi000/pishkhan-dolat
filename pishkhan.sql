...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 27, 2023 at 03:33 PM
...
INSERT INTO `articles` (`id`, `title`, `type`, `text`, `image`, `created_at`, `updated_at`) VALUES
(1, 'آطلاعیه', '1', '<p>اطلاعیه تستی</p>', '/images/articles/1IoZKVghmiRUdSmbRZV1IezYsnxLNqcxrGIdSsW5.png', '2023-02-27 13:57:48', '2023-02-27 13:57:48'),
(2, 'اطلاعیه 2', '1', '<p>تست اطلاعیه</p>', '/images/articles/IcEZn5gN9U2lZdl78bJKpxKcQaCw1ZIlpZQTrL5i.jpg', '2023-02-27 14:00:14', '2023-02-27 14:00:14'),
(3, 'اطلاعیه 3', '1', '<p>متن تست اطلاعیه اطلاعیه تست تست تست تست</p>', '/images/articles/qUlTXjehSjcsD8t3ZACrbmgA6B8pgtf9YDjPUZSR.jpg', '2023-02-27 14:01:20', '2023-02-27 14:01:20');
...
(11, '2023_02_07_213900_create_banners_table', 7),
(12, '2023_02_06_230909_create_articles_table', 8),
(13, '2023_02_06_231528_create_article_videos_table', 8),
(14, '2023_02_05_224852_create_contacts_table', 9),
(15, '2023_02_09_232356_create_office_users_table', 9),
(16, '2023_02_26_102521_add_fileds_to_offices_table', 10);
...
CREATE TABLE `offices` (
  ...
  `national_card_series` varchar(255) NOT NULL,
  `national_code` varchar(255) NOT NULL,
  `father_name` varchar(255) NOT NULL,
  `phone` varchar(255) NOT NULL,
  `birth_certificate_number` varchar(255) NOT NULL,
  `birth_certificate_series` varchar(255) NOT NULL,
  `birth_certificate_serial` varchar(255) NOT NULL,
  ...
  `office_permit` longtext NOT NULL,
  `national_card` longtext NOT NULL,
  `national_card_back` longtext NOT NULL,
  `bank_account` longtext NOT NULL,
  `commitment_letter` longtext NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
